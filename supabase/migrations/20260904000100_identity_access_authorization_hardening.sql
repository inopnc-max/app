...
create policy profiles_admin_select on public.profiles for select to authenticated using (id=auth.uid() or private.is_admin_aal2_self());
create policy profiles_admin_update on public.profiles for update to authenticated using (private.is_admin_aal2_self()) with check (private.is_admin_aal2_self());
